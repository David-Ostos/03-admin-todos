    ...
    <div className="sticky z-10 top-0 h-16 border-b border-gray-300 bg-white lg:py-2.5">
          <div className="px-6 flex items-center justify-between space-x-4">
            ...
            <div className="flex space-x-2">
              ...
              <button className="flex items-center justify-center w-10 h-10 rounded-xl border border-gray-300 bg-gray-100 focus:bg-gray-100 active:bg-gray-200 md:hidden">
                <CiSearch />
              </button>
